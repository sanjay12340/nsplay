...
class SinglePanaPage extends StatefulWidget {
  ...
  @override
  _SinglePanaPageState createState() => _SinglePanaPageState();
}

class _SinglePanaPageState extends State<SinglePanaPage> {
  var balance = "0".obs;
