...
class PanaFamily extends StatefulWidget {
  ...
  @override
  _PanaFamilyState createState() => _PanaFamilyState();
}

class _PanaFamilyState extends State<PanaFamily> {
  var balance = "0".obs;
  ...
  final String _gametype = "Pana Family";
  final String _gametypedb = "pana_family";
                                                                      ...
                                                                      builder: (BuildContext
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            const Text("*Note: Bid once played cannot be cancelled*",
