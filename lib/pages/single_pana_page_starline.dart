...
import 'package:nsplay/utils/single_pana_list.dart';
...
class SinglePanaPageStarline extends StatefulWidget {
  final GameResultModelStarline? gameResultModelStarline;
  SinglePanaPageStarline({Key? key, required this.gameResultModelStarline})
      : super(key: key);

  @override
  _SinglePanaPageStarlineState createState() => _SinglePanaPageStarlineState();
}

class _SinglePanaPageStarlineState extends State<SinglePanaPageStarline> {
  var balance = "0".obs;
  ...
  void jodiDat() {
    List<Map<String, String>> data = listSinglePana;
            ...
            Expanded(
              child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (int.parse(n[index].number!) > 99 &&
                        int.parse(n[index].number!) < 1000) {
                      return n[index];
                    } else if (int.parse(n[index].number!) < 10) {
                      return Container(
                        alignment: Alignment.center,
                        child: Card(
                          elevation: 8,
              ...
              if (i.controller.text.toString() != "") {
                if (int.parse(i.controller.text.toString()) > 9) {
                  ...
                  _betList.add(BetNumberStarlineModal(
                    gameid: int.parse(widget.gameResultModelStarline!.id!),
                    time: widget.gameResultModelStarline!.time!,
                    date: "${d.year}-${d.month}-${d.day}",
                    gametype: "SinglePana",
                    gametypefull: "Single Pana",
