...
class SPDPTPMotor extends StatefulWidget {
  ...
  @override
  _SPDPTPMotorState createState() => _SPDPTPMotorState();
}

class _SPDPTPMotorState extends State<SPDPTPMotor> {
  var balance = "0".obs;
  ...
  final String _gametype = "SP DP TP";
  final String _gametypedb = "sp_dp_tp_motor";
  ...
  void addGenClass(
      GenratedNumberWithGameType genratedNumberWiGenratedNumberWithGameType) {
    _genNumberClass.add(genratedNumberWiGenratedNumberWithGameType);
  }
                                      ...
                                      if (_formKey.currentState!.validate()) {
                                        ...
                                        if (_selectedValue != "Select Market" &&
                                          ...
                                          List<Map<String, String>> list =
                                              GenrateMotorNumber.spDpTpMotor(
                                          ...
                                          if (_selectedValue.value ==
                                            ...
                                            Get.defaultDialog(
                                              ...
                                              !_selectedValue.value
                                                  .contains("Select Market")) {
                                            Get.defaultDialog(
                                                title: "Alert",
                                                middleText:
                                                    "Please Select Atleast one SP, DP, TP");
                                          }
                                        }
                                      }
                                    },
  ...
  Expanded checkBoxSpDpTp({required bool value, required String? name}) {
    return Expanded(
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
