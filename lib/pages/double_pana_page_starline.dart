...
import 'package:nsplay/utils/double_pana_list.dart';
...
class DoublePanaPageStarline extends StatefulWidget {
  final GameResultModelStarline? gameResultModelStarline;
  DoublePanaPageStarline({Key? key, required this.gameResultModelStarline})
      : super(key: key);

  @override
  _DoublePanaPageStarlineState createState() => _DoublePanaPageStarlineState();
}

class _DoublePanaPageStarlineState extends State<DoublePanaPageStarline> {
  var balance = "0".obs;
  ...
  void jodiDat() {
    List<Map<String, String>> data = listDoublePana;
