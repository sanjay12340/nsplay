...
class DoublePanaPage extends StatefulWidget {
  ...
  @override
  _DoublePanaPageState createState() => _DoublePanaPageState();
}

class _DoublePanaPageState extends State<DoublePanaPage> {
  var balance = "0".obs;
