...
class JodiFamily extends StatefulWidget {
  final GameResultModel? gameResultModel;

  const JodiFamily({Key? key, @required this.gameResultModel})
      : super(key: key);

  @override
  _JodiFamilyState createState() => _JodiFamilyState();
}

class _JodiFamilyState extends State<JodiFamily> {
  var balance = "0".obs;
  ...
  final String _gametype = "Jodi Family";
  final String _gametypedb = "jodi";
