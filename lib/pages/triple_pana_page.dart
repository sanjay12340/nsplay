...
class TriplePanaPage extends StatefulWidget {
  ...
  @override
  _TriplePanaPageState createState() => _TriplePanaPageState();
}

class _TriplePanaPageState extends State<TriplePanaPage> {
  var balance = "0".obs;
